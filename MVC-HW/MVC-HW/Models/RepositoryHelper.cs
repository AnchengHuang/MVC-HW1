namespace MVC_HW.Models
{
	public static class RepositoryHelper
	{
		...
		public static CUSTOMER_DETAILRepository GetCUSTOMER_DETAILRepository()
		{
			var repository = new CUSTOMER_DETAILRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static CUSTOMER_DETAILRepository GetCUSTOMER_DETAILRepository(IUnitOfWork unitOfWork)
		{
			var repository = new CUSTOMER_DETAILRepository();
